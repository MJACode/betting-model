...
| Date | File | Entry |
|---|---|---|
| 2026-09-02 | [2026-09](./2026-09.md) | 2026-09-02, session 132 — WNBA: model-first path CLOSED by experiment; the market-relative prop rule ported; my assists re-cut WITHDRAWN at merge (moved out of CLAUDE.md verbatim, session 169) |
| 2026-09-02 | [2026-09](./2026-09.md) | 2026-09-02, session 169 — the Record tab was empty because the record view had outgrown the API timeout |
