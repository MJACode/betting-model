...
| Date | File | Entry |
|---|---|---|
| 2026-09-11 | [2026-09](./2026-09.md) | 2026-09-11, session 280 - the app's bundled thresholds.ts is the cold-start fallback and nothing tested it against config.py: 1 live model absent outright (nfl_live_prop, announcing on Discord while the app refused all its BETs), 16 paused-here-live-there, 3 live-here-paused-there, 24 cut mismatches and 40 missing price floors; synced and pinned by tests/test_mobile_threshold_parity.py. Separately measured: 11 paused models hold 1,395 settled BETs the Models tab drops entirely - not fixed |
