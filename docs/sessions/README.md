...
| Date | File | Entry |
|---|---|---|
| 2026-09-09 | [2026-09](./2026-09.md) | 2026-09-09, session 268 - one live room per sport (DISCORD_WEBHOOK_LIVE_{SPORT}): every live pick had been falling into the pre-game channels because no live webhook was ever set; the NFL live loop was announcing nothing and now calls both notifiers; the probe reports live:{SPORT} |
