...
| Date | File | Entry |
|---|---|---|
| 2026-09-05 | [2026-09](./2026-09.md) | 2026-09-05, session 234 — the wind bet that showed in the app and not in Discord, and the repair path that still read the abandoned table |
