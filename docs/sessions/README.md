...
| Date | File | Entry |
|---|---|---|
| 2026-09-03 | [2026-09](./2026-09.md) | 2026-09-03, session 208 — the Models tab priced unpriced UFC picks at a fabricated -110 and the Record tab did not; one `flatPnl` rule for every client tally, `· N unpriced` on both rows |
