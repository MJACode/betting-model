...
| Date | File | Entry |
|---|---|---|
| 2026-09-13 | [2026-09](./2026-09.md) | 2026-09-13, session 301 - widen uq_picks_one_row_per_pick with player_key + prop_market so nfl_prop_market null player_id rows no longer collide (Matt / Reviewer #699 A2; DAL@NYG IntegrityError). Follow-up, not a #699 blocker |
