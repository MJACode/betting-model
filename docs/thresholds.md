...
| `mlb_total_public_fade` | 0% | 0% | **2026-09-19 PAPER steam rule.** Fade public OVER steam (tix ≥75 and money ≥ tix), max 2 / slate, bet UNDER. INSERT off until `MLB_TOTAL_PUBLIC_FADE_PUBLISH=1`. `docs/mlb_total_public_fade.md`. |
