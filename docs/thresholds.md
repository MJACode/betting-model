...
| `mlb_spread_market` | 0% | 1.8% | **2026-09-15 PAPER-GATED rule.** De-vig Pinnacle, bet a bettable soft book at the same ±1.5. INSERT off until `MLB_SPREAD_MARKET_PUBLISH=1`. **2026-09-19 remesure (production as-of): 368 / +15.75u / +4.3% Apr–Sep 18; Sep 40 / +2.09u / +5.2%; Apr/May red; max 7/day. Does not clear ship bar. Family parked.** `mlb_runline` stays paused. `docs/mlb_spread_market_2026.md`. |
...
| `mlb_spread_market` | 0% | 1.8% | **2026-09-15 PAPER-GATED rule.** Pinnacle vs bettable soft, equal ±1.5. INSERT off until `MLB_SPREAD_MARKET_PUBLISH=1`. 2026-09-19 remesure does not clear ship bar (`docs/mlb_spread_market_2026.md`). |
