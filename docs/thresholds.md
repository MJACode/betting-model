...
| `mlb_runline` | 68% | 11% | 2026-07-02 CORRECTION #2: the 06-28 0.55/0.10 loosen rested on the view sign bug (corrected: -20.6%/91). New optimum 0.68/0.11 = 19 bets 13-6 +20.0%. 2026-07-04: model swapped to v20260704_121650, cut carried over unvalidated (very low expected volume). **2026-08-21 DORMANT; 2026-08-31 PAUSED (mike).** 2026-09-15 publish path is `mlb_spread_market` at 1.8pp — not an unpause. `docs/mlb_runline_ou_edge_search.md`. |
| `mlb_spread_market` | 0% | 1.8% | **2026-09-15 LIVE rule.** Pinnacle vs bettable soft, equal ±1.5. 328 bets through Aug +4.16%, both halves +. `docs/mlb_runline_ou_edge_search.md`. |
