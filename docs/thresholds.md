...
| `mlb_spread_market` | 0% | 1.8% | **2026-09-15 PAPER-GATED rule.** De-vig Pinnacle, bet a bettable soft book at the same ±1.5. INSERT off until `MLB_SPREAD_MARKET_PUBLISH=1`. `mlb_runline` stays paused. 2026-09-16: worker 2pp +6.82%/234 early flat; 1.8pp still the both-halves+ cell. `docs/mlb_edge_search_2026_09_16.md`. |
| `mlb_total_market` | 0% | 2.0% | **2026-09-15 PAPER rule.** Pin fair − soft implied ≥2pp, equal `total_line`, best soft book from `BEST_LINE_BOOKMAKERS`, pin-lean only (never fade Pinnacle). INSERT gated by `MLB_TOTAL_MARKET_PUBLISH` default 0. `mlb_over_under` stays paused. Do not resurrect 0.50/0.06. **Do not retarget to earliest-unaligned** — that 2pp cell is look-ahead (2025 n=40 +13.29u, median gap 14h; aligned-first n=1). `docs/mlb_edge_search_2026_09_16.md`. |
...
| `mlb_spread_market` | 0% | 1.8% | **2026-09-15 PAPER-GATED rule.** Pinnacle vs bettable soft, equal ±1.5. INSERT off until `MLB_SPREAD_MARKET_PUBLISH=1`. 2026-09-16 worker 2pp +6.82%/234 early flat; 1.8pp still both-halves+. `docs/mlb_edge_search_2026_09_16.md`. |
| `mlb_total_market` | 0% | 2.0% | **2026-09-15 PAPER rule.** Pin fair − soft implied ≥2pp, equal total, `BEST_LINE_BOOKMAKERS`, pin-lean. INSERT off until `MLB_TOTAL_MARKET_PUBLISH=1`. Do not retarget to earliest-unaligned (look-ahead; `docs/mlb_edge_search_2026_09_16.md` §6). |
