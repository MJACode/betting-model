...
| `mlb_total_market` | 0% | 2.0% | **2026-09-15 PAPER rule.** Pin vs bettable soft at the same total, 2pp. GROK Pin-open vs DK-open ≥2pp Apr–Jul ~+11% n≈103 (not reproduced on bettable-soft de-vig May–Jun 2pp −11.13%/79). INSERT gated by `MLB_TOTAL_MARKET_PUBLISH` default 0. `mlb_over_under` stays paused. Do not resurrect 0.50/0.06. `docs/mlb_runline_ou_edge_search.md`. |
...
| `mlb_total_market` | 0% | 2.0% | **2026-09-15 PAPER rule.** 2pp equal total. GROK Pin-vs-DK ≥2pp Apr–Jul ~+11% n≈103. INSERT off until `MLB_TOTAL_MARKET_PUBLISH=1`. `docs/mlb_runline_ou_edge_search.md`. |
