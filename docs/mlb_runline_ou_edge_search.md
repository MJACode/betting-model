...
| Run line | **Do not live-publish pure Pin-vs-soft spreads. Park the 1.8pp BEST_LINE de-vig family.** 2026-09-19 production as-of remesure (last pre-commence, shopped BEST_LINE, −200 floor): **368 / +15.75u / +4.3%** Apr–Sep 18; Sep **40 / +2.09u / +5.2%**; Apr −0.2% / 77 and May −2.2% / 71 — **not month-stable**; max **7**/day. 2.0pp / top-2 / pin-lean / side splits leave a red month; August public last-pre-commence is **0** games (do not fill). GROK Pin-vs-DK ≥2pp remains ~−5% n≈200. Code for `mlb_spread_market` at 1.8pp remains; INSERT gated. `mlb_runline` stays paused. `docs/mlb_spread_market_2026.md`. |
