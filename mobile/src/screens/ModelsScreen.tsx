...
export function ModelsScreen() {
  ...
  // Catalog hide (Matt, 2026-09-19): paused models are not followable — same
  // `isModelPaused` the action filter and Live board already use (server flag,
  // bundled PAUSED_MODELS fallback). The Record tab still lists their settled
  // bets (CLAUDE.md §1c: a pause does not unsay a bet already made). Retired
  // models stay hidden: nothing will ever score another pick for them.
