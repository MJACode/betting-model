...
GO_LIVE_MIN_PICKS    = 50     # a NEW model stays paper-only until ≥50 settled picks
...
def run_backtest(model_id: str, season: int,
    ...
    for game_row in games:
        ...
        if not dk_odds:
            ...
            # WNBA/NBA/NHL h2h: no historical DK odds for these sports yet —
            # same prob-only treatment (NHL games come from the NHL API without
