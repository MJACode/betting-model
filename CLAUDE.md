...
| **Opener strategy (spreads)** | **NOT ESTABLISHED - paper only.** ROI **+1.34%**, 95% CI [-3.9, +6.4] on SIX seasons | RESTATED 2026-08-23 (was +6.82% on three). A 27,300-credit scan added 2020-2022 at the same resolution and the edge did not survive: season ROI **-2.62 / -1.78 / -2.80** / +4.72 / +10.86 / +0.32. Excess +2.27pp [-0.6, +5.1] against a DraftKings placebo of +0.95pp - too close to call. Separately, the backtest had never excluded EXCHANGES though the live card always did; fixing that alone takes 2023-2025 from +6.82% to +5.37% |
